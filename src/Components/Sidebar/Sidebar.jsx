        ...
        <div>
                    <div className="p-0 min-vh-100 bg-dark">
                        <ul className="text-light list-unstyled">
                            ...
                            <li className="p-3 pe-lg-5 sidebar-element">
                                <Link  to={'/login'} className="nav-link px-0 px-lg-2" onClick={logout}> <i className="bi bi-box-arrow-left"></i><span className="px-lg-2 ms-1 d-none d-lg-inline">Logout</span> </Link>
                            </li>
